...
q=97
nvals=20 # Anzahl Elemente in vektor a und b 
a=[]
b=[]
e=[]
s = 5
...
print("\n------Auswahl Elemente vom öffentlichen Schlüssel-------")


sample= random.sample(range(nvals-1), nvals//4) # Auswahl von nvals//4 Elementen
